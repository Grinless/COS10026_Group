...
?>
    ...
    <section class="content">
        <span>
            <br />
            JSON is a data interchange format, a text format used to exchange data between platforms.
            CSV and XML are examples of these formats which may be used to communicate between largely different systems.<span class="reference"><a href="#ref1">[1]</a></span>
        </span>
    </section>
    <br><br><br><br><br>
    <section class="youtubecontent">
        <iframe width="560" height="315" 
			src="https://www.youtube.com/embed/quKLAFc_Khg" 
	...
	<section class="youtubecontent">
		<iframe width="560" height="315" 
			src="https://www.youtube.com/embed/KSitRORes-A" 
			title="YouTube video player" 
			frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
		</iframe>
